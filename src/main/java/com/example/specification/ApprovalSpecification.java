...
public class ApprovalSpecification {
    ...
    public static Specification<RequestApproval> hasRequestNumber(String requestNumber) {
    ...
    public static Specification<RequestApproval> hasApprovalStatus(ApprovalStatus approvalStatus) {
    ...
    public static Specification<RequestApproval> hasApprovalRole(ApprovalRole approvalRole) {
    ...
    public static Specification<RequestApproval> hasCurrentLevel(Boolean currentLevel) {
