...
public class ChangePasswordView extends VerticalLayout {
        ...
        private final Span passwordValidationMessage = new Span();

        private final Span confirmPasswordMessage = new Span();

        public ChangePasswordView(ChangePasswordService changePasswordService, SecurityService securityService) {
                ...
                getStyle()
                        .set("background","linear-gradient(135deg, #eef2ff 0%, #f8fafc 100%)")
                        .set("padding","40px");
                ...
                oldPassword.setPlaceholder("Enter current password");

                newPassword.setPlaceholder("Enter new password");

                confirmPassword.setPlaceholder("Re-enter new password");
                ...
                newPassword.addValueChangeListener(event -> {validatePassword();});

                confirmPassword.addValueChangeListener(event -> {validateConfirmPassword();});
                ...
                changePasswordButton.getStyle()
                                ...
                                .set("background", "linear-gradient(135deg, #2563eb, #4f46e5)")

                                .set("color", "white")

                                .set("font-weight", "700")

                                .set("padding","12px 26px")

                                .set("border-radius","12px")

                                .set("box-shadow","0 8px 22px rgba(37,99,235,0.35)");

                changePasswordButton.addClickListener(event -> updatePassword());
                ...
                card.getStyle()
                                ...
                                .set("box-shadow","0 20px 45px rgba(15,23,42,0.08)");
        ...
        private void validatePassword() {
                ...
                if(errors.isEmpty()) {
                        ...
                        passwordValidationMessage.setText("Strong password");
        ...
        private void validateConfirmPassword() {
                ...
                if(confirmPassword.getValue().equals(newPassword.getValue())) {
                        ...
                        confirmPasswordMessage.setText("Passwords do not match");
